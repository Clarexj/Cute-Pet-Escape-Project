      ...
      _export("HunterUI", HunterUI = (_dec = ccclass('HunterUI'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(_crd && HunterController === void 0 ? (_reportPossibleCrUseOfHunterController({
        ...
        start() {
          ...
          if (this.attackButton) {
            var button = this.attackButton.getComponent(Button);
          ...
          if (this.breakBoardButton) {
            var _button = this.breakBoardButton.getComponent(Button);

            if (_button) {
              _button.node.on(Button.EventType.CLICK, this.onBreakBoardButtonClick, this);
            }
          }
        ...
        updateAttackCooldown() {
          ...
          var canAttack = this.hunterController.canAttack();
          var progress = this.hunterController.getAttackCooldownProgress();
          ...
          if (!canAttack) {
            ...
            var button = (_this$attackButton = this.attackButton) == null ? void 0 : _this$attackButton.getComponent(Button);
            ...
            // 恢复正常显示
            var target = this.hunterController.getAttackTarget();

            if (target) {
              this.attackLabel.string = "\u653B\u51FB " + target.name;
            }

            var _button2 = (_this$attackButton2 = this.attackButton) == null ? void 0 : _this$attackButton2.getComponent(Button);
