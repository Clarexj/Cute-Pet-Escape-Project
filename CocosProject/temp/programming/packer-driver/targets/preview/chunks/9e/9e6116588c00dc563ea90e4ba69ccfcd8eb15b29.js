    ...
    execute: function () {
      ...
      _export("RemotePlayerController", RemotePlayerController = (_dec = ccclass('RemotePlayerController'), _dec(_class = (_class2 = class RemotePlayerController extends Component {
        ...
        interpolatePosition(deltaTime) {
          ...
          var distance = Vec3.distance(this._currentPosition, this._targetPosition); // 如果距离过大，直接传送（防止延迟导致的巨大偏移）
        ...
        interpolateRotation(deltaTime) {
          var currentRotationY = this.node.eulerAngles.y;
          var angleDiff = this.getShortestAngleDifference(currentRotationY, this._targetRotationY); // 如果角度差距很小，直接设置
          ...
          var newRotationY = currentRotationY + angleDiff * this.interpolationSpeed * deltaTime;
        ...
        updatePlayerState(playerData, immediate) {
          if (immediate === void 0) {
            immediate = false;
          }
