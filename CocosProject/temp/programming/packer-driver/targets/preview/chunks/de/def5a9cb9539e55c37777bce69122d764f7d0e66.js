    ...
    execute: function () {
      ...
      _export("HunterController", HunterController = (_dec = ccclass('HunterController'), _dec2 = property(_crd && Joystick === void 0 ? (_reportPossibleCrUseOfJoystick({
        ...
        detectSurvivors() {
          ...
          var nearestDistance = this.attackRange;
        ...
        notifyAttackTargetChange() {
          for (var callback of this._attackCallbacks) {
        ...
        detectBoards() {
          ...
          var nearestDistance = this.boardBreakRange;
          this.node.getWorldPosition(this._tempVec3_1);

          for (var _board of this._allBoards) {
            // 只检测已倒下的木板
            if (_board.getState() !== 'down') continue;

            _board.node.getWorldPosition(this._tempVec3_2);
        ...
        notifyBoardTargetChange() {
          for (var callback of this._boardCallbacks) {
