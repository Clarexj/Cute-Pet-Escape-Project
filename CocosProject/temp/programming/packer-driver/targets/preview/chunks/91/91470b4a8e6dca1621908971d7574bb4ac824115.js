      ...
      _export("LobbyUI", LobbyUI = (_dec = ccclass('LobbyUI'), _dec2 = property(EditBox), _dec3 = property(EditBox), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Label), _dec7 = property(Node), _dec(_class = (_class2 = class LobbyUI extends Component {
        ...
        onCreateRoomClick() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var playerName = _this.getPlayerName();

            if (!playerName) {
              _this.showStatus('请输入玩家名称', true);
            ...
            _this.showStatus('正在创建房间...', false);

            var success = yield _this._networkManager.createRoom(playerName);
            ...
            if (!success) {
              ...
              _this.showStatus('创建房间失败，请重试', true);
            }
          })();
        }
        /**
        ...
        onJoinRoomClick() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var playerName = _this2.getPlayerName();

            var roomId = _this2.getRoomId();

            if (!playerName) {
              _this2.showStatus('请输入玩家名称', true);

              return;
            }

            if (!roomId) {
              _this2.showStatus('请输入房间ID', true);
            ...
            _this2.setButtonsEnabled(false);

            _this2.showLoading(true);

            _this2.showStatus("\u6B63\u5728\u52A0\u5165\u623F\u95F4 " + roomId + "...", false);

            var success = yield _this2._networkManager.joinRoom(roomId, playerName);

            if (!success) {
              _this2._isConnecting = false;

              _this2.setButtonsEnabled(true);

              _this2.showLoading(false);

              _this2.showStatus('加入房间失败，请检查房间ID', true);
            }
          })();
        }
        /**
        ...
        getPlayerName() {
          ...
          var name = this.playerNameInput.string.trim();
        ...
        generateRandomName() {
          var adjectives = ['快乐', '勇敢', '聪明', '可爱', '神秘'];
          var nouns = ['小猫', '小狗', '小兔', '小熊', '小鸟'];
