    ...
    execute: function () {
      ...
      _export("RemotePlayerManager", RemotePlayerManager = (_dec = ccclass('RemotePlayerManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class RemotePlayerManager extends Component {
        ...
        createExistingPlayers() {
          ...
          var allPlayers = this._networkManager.getAllPlayers();

          var localSessionId = this._networkManager.getLocalSessionId();
        ...
        onPlayerChanged(sessionId, playerData) {
          var playerNode = this._remotePlayers.get(sessionId);
          ...
          var remoteController = playerNode.getComponent(_crd && RemotePlayerController === void 0 ? (_reportPossibleCrUseOfRemotePlayerController({
            error: Error()
        ...
        createRemotePlayer(sessionId, playerData) {
          ...
          var playerNode = instantiate(this.remotePlayerPrefab);
